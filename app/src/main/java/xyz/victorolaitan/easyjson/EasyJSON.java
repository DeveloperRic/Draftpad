...
public class EasyJSON {
     ...
     */
    public static EasyJSON open(File file) throws IOException, EasyJSONException {
     ...
     * @throws EasyJSONException if the file's JSON structure is incompatible with EasyJSON.
     */
    public static EasyJSON open(String filePath) throws IOException, EasyJSONException {
    ...
    private EasyJSON() {
        rootNode = new JSONElement<Void>(this, null, JSONElementType.ROOT, null, null);
    }
    ...
    private <T> T deepSave(T currentJSONRef, JSONElement currentElement) throws EasyJSONException {
        for (int i = 0; i < currentElement.getChildren().size(); i++) {
            JSONElement child = (JSONElement) currentElement.getChildren().get(i);
            Object objectToAdd;
